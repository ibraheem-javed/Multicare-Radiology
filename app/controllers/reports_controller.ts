...
import GetReport from '#actions/reports/get_report'
import GetDataForCreate from '#actions/reports/get_data_for_create'
import CreateReport from '#actions/reports/create_report'
import UpdateReport from '#actions/reports/update_report'
import DeleteReport from '#actions/reports/delete_report'
...
export default class ReportsController {
  ...
  async edit({ params, inertia }: HttpContext) {
    const report = await this.getReport.handleForEdit(params.id)
